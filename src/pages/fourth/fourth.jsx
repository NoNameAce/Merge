...
export function ProDeteil() {
  return <div className='box1'>
    ...
    <div className='div-in-box1'>
      <img className='img-1' src={img41} alt="" />
      <div className='div-2'>
        ...
        <div className='div3-in-box1'>
          <div>
            <p>Current Bid</p>
            <div style={{ display: 'flex', alignItems: 'center' }}><img src={eth} alt="" /><h3>1.75</h3></div>
          </div>
        ...
        <button className='button1'><img src={vec} alt="" />Place Bid</button>
      </div>
    </div>
  </div>
}
